...
<div id="maincontainer">
  ...
  <div id="leftcolumn">
	<div class="innertube">
	  <ul id="lefttabs">
	  <li><a href="?mn=1" <? if($_REQUEST['mn']==1) echo 'id="current"'; ?>>New Request Sharing</a>
<!--  <li><a href="?mn=2" <? if($_REQUEST['mn']==2) echo 'id="current"'; ?>>Request To Attend</a> -->
	  <li><a href="?mn=3" <? if($_REQUEST['mn']==3) echo 'id="current"'; ?>>Sharing Knowledge Status</a>
<!-- <li><a href="?mn=4" <? if($_REQUEST['mn']==4) echo 'id="current"'; ?>>Feedback</a> 
	  <li><a href="?mn=5" <? if($_REQUEST['mn']==5) echo 'id="current"'; ?>>Sharing Knowledge Archives</a>-->
  	  <li><a href="?mn=6" <? if($_REQUEST['mn']==6) echo 'id="current"'; ?>>Upload SK / CEO note</a></li>
  	  <li><a href="?mn=5" <? if($_REQUEST['mn']==5) echo 'id="current"'; ?>>Books</a></li>
  	  </ul>
	</div>
  </div>

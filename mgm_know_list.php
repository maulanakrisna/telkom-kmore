...
// Step 1
$judul = "Sharing Knowledge Archives";
...
$query .= "JOIN loker c ON b.id_bidang=c.id_loker JOIN knowledge_map d ON a.id_map=d.id_map ";
$query .= "WHERE sharing_status='6'";
*/
$query  = "SELECT a.*, b.nama, b.id_bidang, c.nm_loker FROM knowledge a JOIN user b ON a.nik=b.nik ";
$query .= "JOIN loker c ON b.id_loker=c.id_loker ";
$query .= "WHERE sharing_status='6'";
...
<form method="post" action="<?= $_SERVER['PHP_SELF'];?>?mn=5" >
<input type="text" size="25" name="keyword" value="<?= $_REQUEST[keyword] ?>">&nbsp;<input type="submit" value="Cari" class="button">
</form>
	</td>
	<td align='right'>
	<form name="addknow" action="<?= $_SERVER["PHP_SELF"]?>?mn=51" method="post">
	<input type="submit" value="Add Knowledge" class="button">
	</form>
	</td>
	</tr>
	</table>
...
echo "<th>Tanggal/Jam&nbsp;<a href='?mn=5&sort=t_mulai&by=ASC'><img src='images/up.png' border='0'></a><a href='?mn=5&sort=t_mulai&by=DESC'><img src='images/down.png' border='0'></a></th>";
echo "<th>Judul&nbsp;<a href='?mn=5&sort=judul&by=ASC'><img src='images/up.png' border='0'></a><a href='?mn=5&sort=judul&by=DESC'><img src='images/down.png' border='0'></a></th>";
echo "<th>Pembicara&nbsp;<a href='?mn=5&sort=nama&by=ASC'><img src='images/up.png' border='0'></a><a href='?mn=5&sort=nama&by=DESC'><img src='images/down.png' border='0'></a>";
#echo "</th><th>Bidang&nbsp;<a href='?mn=5&sort=nm_loker&by=ASC'><img src='images/up.png' border='0'></a><a href='?mn=5&sort=nm_loker&by=DESC'><img src='images/down.png' border='0'></a></th></tr></thead>";
...
?>
	<tr valign="top">
		...
		<td width="39%"><a href="management.php?id=<?= $row["id_know"]; ?>&mn=52" title="Edit Sharing Knowledge"><?= $row["judul"]; ?></a><br><?= $row['abstraksi'];?></td>

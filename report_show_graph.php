...
//    $link = connectToDB();
	...
	*/
	$query  = "SELECT c.id_bidang, singkatan, c.nm_bidang, SUM(a.poin) AS nilai FROM sharing_activity a ";
	...
	while($ors = mysql_fetch_array($result)) {
		...
		$strXML .= "<set name='" . $ors['singkatan'] . "' value='" . $ors['nilai'] . "' color='" . $colors[$i] . "'/>";
		$i++;
	}
   // mysql_close($link);

...
$q = "SELECT nm_bidang FROM bidang WHERE id_bidang='$_REQUEST[idb]'";
#echo "$q<br>";
query_sql($q,$res);
$r = mysql_fetch_array($res);
$judul = "Sharing Point ".$r['nm_bidang'];
...
$query .= "WHERE a.id_bidang='$_REQUEST[idb]' AND a.id_inv_status < '3' AND a.poin IS NOT NULL ORDER BY a.poin DESC";

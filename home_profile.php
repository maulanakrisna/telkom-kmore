...
/*
-----
file asal  : home_profile.php
file tujuan: save2db.php?sw=hp
-----
*/
?>
	<br>
	<form name= "myform" class="cmxform" id="commentForm" action="save2db.php" method="post">
		<fieldset>
			...
			*/
			...
			<p>
				<label for="cbidang">Bidang :&nbsp;*</label>
				<select name="id_bidang" class="required">
				<option value="">- Choose -</option>
				<?
				   $tSQL = "SELECT * FROM bidang"; 
				...
				?>
				<option value="<?= $listrow["id_bidang"]; ?>">
				<? echo $spacer.$listrow["nm_bidang"]; ?>
				</option>
				<?
					   $cur++;
				   }
			...
			<p>
				...
				?>
				<option value="<?= $listrow["id_loker"]; ?>">
				<? echo $spacer.$listrow["nm_loker"]; ?>
				</option>
				<?
					   $cur++;
				   }

...
/** 
 * @version V1.64 20 Dec 2001 (c) 2000, 2001 John Lim (jlim@natsoft.com.my). All rights reserved.
...
*/
 ...
 if (!defined('_ADODB_LAYER')) {
	 ...
	 */
	$ADODB_vers = 'V1.64 20 Dec 2001 (c) 2000, 2001 John Lim (jlim@natsoft.com.my). All rights reserved. Released BSD & LGPL.';
	...
	* @return		the recordset ($rs->databaseType == 'array')
	...
	function GetUpdateSQL(&$rs, $arrFields,$forceUpdate=false)
	{
		...
		return _adodb_getupdatesql($this,$rs,$arrFields,$forceUpdate);
	}
	...
	{	
		include_once(ADODB_DIR.'/adodb-lib.inc.php');
		return _adodb_getinsertsql($this,$rs,$arrFields);
	}
    ...
    function PO_RecordCount($table="", $condition="") {
        ...
        if ($lnumrows == -1 && $this->connection) {
            IF ($table) {
                ...
                if ($resultrows) $lnumrows = $resultrows->fields[0];
            }
        }
        return $lnumrows;
    }

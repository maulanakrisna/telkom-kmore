...
<div id="maincontainer">
  ...
  */
	...
	<div id="contentcolumn">
	  <div class="innertube">
		...
		<ul class="tree"><a href="mgm_sharing.php">Management</a>
			...
			<li><a href="management.php?mn=3">Sharing Knowledge Status</a>
			<li><a href="management.php?mn=5">Sharing Knowledge Archives</a>
		</ul>
		<? } ?>
  ...
  {
	  echo "<br><CENTER>Session Anda telah berakhir. Silakan login kembali di <a href='http://portal.telkom.co.id'>POINT</a></CENTER><br>";
  }
  */
  include ("footer.php");
  ?>

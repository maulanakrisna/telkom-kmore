...
// Step 2
$query  = "SELECT a.*, b.nama, c.nik, c.id_inv_status, c.id_confirm, e.nm_confirm, b.id_bidang, d.nm_loker ";
$query .= "FROM knowledge a JOIN user b ON a.nik=b.nik JOIN sharing_activity c ON a.id_know=c.id_know ";
$query .= "JOIN loker d ON b.id_bidang=d.id_loker JOIN confirm e ON c.id_confirm=e.id_confirm ";
$query .= "WHERE (sharing_status='3' AND c.nik = '$_SESSION[nik_login]' AND c.id_inv_status='3' AND c.id_confirm<>'0') OR ";
$query .= "(sharing_status='3' AND c.nik = '$_SESSION[nik_login]' AND a.t_mulai<NOW())";
...
<?
echo "</td><td align='right'><a href='?mn=2'>Invitation</a></td></tr></table>";
echo "<center>";

# print table header
echo "<table id='myTable' class='tablesorter' border='0' cellpadding='0' cellspacing='1'>";
echo "<thead><tr><th>No.</th>";
echo "<th>Tanggal/Jam&nbsp;<a href='?mn=21&sort=t_mulai&by=ASC'><img src='images/up.png' border='0'></a><a href='?mn=21&sort=t_mulai&by=DESC'><img src='images/down.png' border='0'></a></th>";
echo "<th>Judul&nbsp;<a href='?mn=21&sort=judul&by=ASC'><img src='images/up.png' border='0'></a><a href='?mn=21&sort=judul&by=DESC'><img src='images/down.png' border='0'></a></th>";
echo "<th>Pembicara&nbsp;<a href='?mn=21&sort=nama&by=ASC'><img src='images/up.png' border='0'></a><a href='?mn=21&sort=nama&by=DESC'><img src='images/down.png' border='0'></a></th>";
echo "<th>Bidang</th><th>Confirm</th></tr></thead>";
echo "<tbody>";
...
if ($num <> 0)
{
	...
	<tr valign="top">
		...
		<td>
		<A HREF="sharing_detail_view.php?idk=<?= $row["id_know"]; ?>&mn=1&height=400&width=650" title="Sharing Knowledge Invitation Detail" class="thickbox"><?= $row["judul"]; ?></A>
		</td>
		<td><?= $row["nama"]; ?></td>

...
// Step 2
$query  = "SELECT a.*, b.judul, b.t_mulai, b.t_akhir, c.nama, d.nm_loker, e.nm_confirm FROM sharing_activity a ";
$query .= "JOIN knowledge b ON a.id_know=b.id_know JOIN user c ON b.nik=c.nik JOIN loker d ON c.id_loker=d.id_loker ";
...
<?
echo "</td><td align='right'><a href='?mn=31'>Request to Attend History</a></td></tr></table>";
echo "<center>";

# print table header
echo "<table id='myTable' class='tablesorter' border='0' cellpadding='0' cellspacing='1'>";
echo "<thead><tr><th>No.</th><th>Date/Time</th><th>Title/Theme</th><th>Contributor</th><th>Bidang</th><th>Status</th></tr></thead>";
echo "<tbody>";

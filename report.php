...
<div id="maincontainer">
  ...
  <div id="contentwrapper">
	<div id="contentcolumn">
	  ...
	  {
		case 1:
			include("report_point_mine.php");
			break;
		case 2:
			include("report_point_individu.php");
			break;
		
		case 3:
			include("report_point_bidang.php");
			break;
		
		case 4:
			include("report_point_knowmap.php");
			break;
		case 5:
			include("report_point_loker.php");
			break;
  ...
  <div id="leftcolumn">
	<div class="innertube">
	  <ul id="lefttabs">
	  <li><a href="?mn=1" <? if($_REQUEST['mn']==1) echo 'id="current"'; ?>>My Points</a>
	  <li><a href="?mn=2" <? if($_REQUEST['mn']==2) echo 'id="current"'; ?>>Sharing Point Individu</a>
<!--	 <li><a href="?mn=3" <? if($_REQUEST['mn']==3) echo 'id="current"'; ?>>Sharing Point Bidang</a> -->
	 	 <li><a href="?mn=5" <? if($_REQUEST['mn']==5) echo 'id="current"'; ?>>Sharing Point Unit</a> 

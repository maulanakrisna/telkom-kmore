...
<html>
<head>
<title>KMORE - Administration Page</title>
...
<div id="maincontainer">
  ...
  <div id="contentwrapper">
	...
	<!-- <div style="clear:both"></div> -->
	  ...
	  {
		case 1:
			include('adm_user_list.php');
			break;
		case 11:
			#include("inc_under.php");
			include("adm_user_add.php");
			$_REQUEST['mn']=1;
			break;
		case 12:
			include("adm_user_edt.php");
			$_REQUEST['mn']=1;
			break;
		case 13:
			...
			break;
		case 2:
			include("adm_loker_list.php");
			break;
		case 21:
			#include("adm_loker_add.php");
			include("inc_under.php");
			$_REQUEST['mn']=2;
			break;
		case 22:
			include("adm_loker_edt.php");
			$_REQUEST['mn']=2;
			break;
		case 3:
			include("adm_bidang_list.php");
			break;
		case 31:
			#include("adm_bidang_add.php");
			include("inc_under.php");
			break;
		case 32:
			include("adm_bidang_edt.php");
			$_REQUEST['mn']=3;
			break;
		case 4:
			include("adm_kmap_list.php");
			break;
		case 41:
			include("adm_kmap_add.php");
			$_REQUEST['mn']=4;
			break;
		case 42:
			include("adm_kmap_edt.php");
			$_REQUEST['mn']=4;
			break;
		case 5:
			include("adm_books_view.php");
			$_REQUEST['mn']=5;
			break;
		case 51:
			include("adm_book_add.php");
			$_REQUEST['mn']=5;
			break;
  ...
  <div id="leftcolumn">
	<div class="innertube">
	  <ul id="lefttabs">
	  <li><a href="?mn=1" <? if($_REQUEST['mn']==1) echo 'id="current"'; ?>>Data User</a>
	  <li><a href="?mn=2" <? if($_REQUEST['mn']==2) echo 'id="current"'; ?>>Loker</a>
<!--	  <li><a href="?mn=3" <? if($_REQUEST['mn']==3) echo 'id="current"'; ?>>Bidang</a>-->
	  <li><a href="?mn=4" <? if($_REQUEST['mn']==4) echo 'id="current"'; ?>>Knowledge Map</a>
  	  <li><a href="?mn=5" <? if($_REQUEST['mn']==5) echo 'id="current"'; ?>>Books</a>
	  </ul>
	</div>
  </div>

...
<div id="maincontainer">
  ...
  <div id="contentwrapper">
	<div id="contentcolumn">
	  ...
	  {
		case 1:
			include("index_schedule.php");
			break;
		case 2:
			include("index_invitation.php");
			break;
		case 21:
			include("index_invitation_his.php");
			$_REQUEST['mn']=2;
			break;
		case 3:
			include("index_req2_attend.php");
			break;
		case 31:
			include("index_req2_attend_his.php");
			$_REQUEST['mn']=3;
			break;
		case 4:
			include("index_archives.php");
			break;
		case 5:
  ...
  <div id="leftcolumn">
	<div class="innertube">
	  ...
	  <li><a href="?mn=4" <? if($_REQUEST['mn']==4) echo 'id="current"'; ?>>Archives</a>

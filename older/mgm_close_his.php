...
$query = "SELECT a.*, b.nama, b.id_bidang, c.nm_loker, d.nama AS appname FROM knowledge a JOIN user b ON a.nik=b.nik JOIN loker c ON b.id_bidang=c.id_loker JOIN user d ON a.app_req_by=d.nik WHERE sharing_status='6'";
#echo "$query<br>";
...
<?
echo "</td><td align='right'><a href='?mn=3'>Sharing Task Status</a></td></tr></table>";
echo "<center>";

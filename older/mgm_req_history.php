...
// Step 2
$query = "SELECT a.*, b.nama, b.id_bidang, c.acronym, d.nama AS appname FROM knowledge a JOIN user b ON a.nik=b.nik JOIN loker c ON b.id_bidang=c.id_loker JOIN user d ON a.app_req_by=d.nik WHERE a.app_req_by IS NOT NULL AND sharing_status IN ('2','3')";
